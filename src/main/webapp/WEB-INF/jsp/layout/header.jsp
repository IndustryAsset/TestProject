...
#headerContainer{
	...
	background:-webkit-gradient(linear, left top, left bottom, color-stop(0.05, #064d81), color-stop(1, #064d81));
	...
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#064d81', endColorstr='#064d81',GradientType=0);
...
<div id="headerContainer" >
	<table width="100%">
		<tr>
			<td width="33%" style="vertical-align: middle;"><img height="60" src="css/images/accenture-blue.jpg" id="logo"/></td>
			<td width="33%" align="center" style="font-size: 24px">
				<b>Engagement Dashboard</b>
			</td>
