...
<script>
function lowerCase() {
    var str =  document.getElementById("enterpriseId").value;
    var res = str.toLowerCase();
    alert(res);
    document.getElementById("enterpriseId").value = res;
}
</script>
<script>
...
<body onload="preventBack();">
	...
	<form action="idCheck.htm">
		...
		<div class="login-box animated fadeInUp">
			...
			<br/>
			<input type="text" id="enterpriseId" name = "enterpriseId" onBlur="lowerCase()" >
			<br/>
