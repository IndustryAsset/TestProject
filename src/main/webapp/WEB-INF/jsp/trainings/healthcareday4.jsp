...
<body>
	...
	<div class="reveal">
		...
		<div id="main">
			<h6 align="center">HEALTH CARE OVERVIEW DAY 4</h6>

			<div class="slides">
				<section id="slide1">
					<img src="images\health\day4\Slide1.PNG">
				</section>
				<section id="slide2">
					<img src="images\health\day4\Slide2.PNG">
				</section>
				<section id="slide3">
					<img src="images\health\day4\Slide3.PNG">
				</section>

				<section id="slide4">
					<img src="images\health\day4\Slide4.PNG">
				</section>

				<section id="slide5">
					<img src="images\health\day4\Slide5.PNG">
				</section>

				<section id="slide6">
					<img src="images\health\day4\Slide6.PNG">
				</section>

				<section id="slide7">
					<img src="images\health\day4\Slide7.PNG">
				</section>

				<section id="slide8">
					<img src="images\health\day4\Slide8.PNG">
				</section>
				<section id="slide9">
					<img src="images\health\day4\Slide9.PNG">
				</section>
				<section id="slide10">
					<img src="images\health\day4\Slide10.PNG">
				</section>
				<section id="slide11">
					<img src="images\health\day4\Slide11.PNG">
				</section>

				<section id="slide12">
					<img src="images\health\day4\Slide12.PNG">
				</section>

				<section id="slide13">
					<img src="images\health\day4\Slide13.PNG">
				</section>

				<section id="slide14">
					<img src="images\health\day4\Slide14.PNG">
				</section>
				<section id="slide15">
	...
	Reveal.initialize({
		...
		Reveal.addEventListener('slidechanged', function(slidechanged) {
			...
			$.ajax({
				...
				type : 'POST',
				url : 'updateSlide.htm?topicId=11&slideNumber=' + slideNumber,
			...
			if (slideNumber == (horzSlideCnt - 1)) {
				$.ajax({
					...
					type : 'POST',
					url : 'completeStatus.htm?topicId=11',
